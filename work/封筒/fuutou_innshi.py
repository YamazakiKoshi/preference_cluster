...
# データの読み込み
df_workers = pd.read_csv("./work/data/feature/fuutouonly.csv", encoding="utf-8")
...
# Excelファイルに保存
excel_file_path = "封筒固有値.xlsx"
df_factor_loadings.to_excel(excel_file_path, index=False)

# 因子分析の実行（最尤法を使用）
fa_ml = FactorAnalyzer(n_factors=14, method='uls', rotation="oblimin")
fa_ml.fit(df_workers_std)



# 因子負荷量，共通性
loadings_df_ml = pd.DataFrame(fa_ml.loadings_, columns=["第1因子", "第2因子", "第3因子", "第4因子", "第5因子","第6因子", "第7因子", "第8因子", "第9因子", "第10因子","第11因子", "第12因子","第13因子", "第14因子"])
...
# Excelファイルに保存
excel_file_path_ml = "封筒因子負荷量.xlsx"
...
df_var_ml = pd.DataFrame(list(zip(var_ml[0], var_ml[1], var_ml[2])), 
                      index=["第1因子", "第2因子", "第3因子", "第4因子", "第5因子","第6因子", "第7因子", "第8因子", "第9因子", "第10因子","第11因子", "第12因子","第13因子", "第14因子"], 
...
factor_correlation_df = pd.DataFrame(factor_correlation, 
                                     columns=["第1因子", "第2因子", "第3因子", "第4因子", "第5因子","第6因子", "第7因子", "第8因子", "第9因子", "第10因子","第11因子", "第12因子","第13因子", "第14因子"],
                                     index=["第1因子", "第2因子", "第3因子", "第4因子", "第5因子","第6因子", "第7因子", "第8因子", "第9因子", "第10因子","第11因子", "第12因子","第13因子", "第14因子"])
# 結果をExcelファイルに保存
excel_file_path_correlation = "封筒因子間相関.xlsx"
...
df_factor_only.to_excel("封筒因子得点.xlsx", index=False)
