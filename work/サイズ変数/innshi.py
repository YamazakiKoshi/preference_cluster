...
# データの読み込み
# df_workers = pd.read_csv("./work/data/feature/size_kikaku.csv", encoding="utf-8")
# df_workers = df_workers.drop('得意先コード', axis=1)
# # データの読み込み
df_workers = pd.read_csv("./work/data/feature/size_log.csv", encoding="utf-8")
df_workers = df_workers.drop('得意先コード', axis=1)
...
# # NaNの行数を確認
# nan_row_count = df_workers_std.isna().sum(axis=1).sum()
# print("NaNの行数:", nan_row_count)
# # 各列ごとのNaNの個数を確認
# nan_column_count = df_workers_std.isna().sum()
# nan_column_count.to_csv('NaN.csv', index=False, encoding='utf-8')
# print("各列ごとのNaNの個数:")
# print(nan_column_count)
...
# Excelファイルに保存
excel_file_path = "サイズ固有値.xlsx"
df_factor_loadings.to_excel(excel_file_path, index=False)

# FactorAnalyzerのインスタンスを生成する際にregularizationパラメータを指定
fa_ml = FactorAnalyzer(n_factors=5, method='ml', rotation="oblimin")
...
# Excelファイルに保存
excel_file_path_ml = "サイズ因子負荷量.xlsx"
...
#                       index=["第1因子", "第2因子", "第3因子", "第4因子", "第5因子","第6因子", "第7因子", "第8因子", "第9因子", "第10因子","第11因子", "第12因子",
#                                                         "第13因子", "第14因子", "第15因子", "第16因子", "第17因子","第18因子", "第19因子", "第20因子", "第21因子","第22因子", "第23因子","第24因子", "第25因子","第26因子"
#                                                         ,"第27因子", "第28因子", "第29因子", "第30因子", "第31因子","第32因子"], 
...
# # Excelファイルに保存
# excel_file_path_ml = "サイズ寄与率.xlsx"
# df_factor_loadings_ml.to_excel(excel_file_path_ml, index=False)
...
#                                      columns=["第1因子", "第2因子", "第3因子", "第4因子", "第5因子","第6因子", "第7因子", "第8因子", "第9因子", "第10因子","第11因子", "第12因子",
#                                                         "第13因子", "第14因子", "第15因子", "第16因子", "第17因子","第18因子", "第19因子", "第20因子", "第21因子","第22因子", "第23因子","第24因子", "第25因子","第26因子"
#                                                         ,"第27因子", "第28因子", "第29因子", "第30因子", "第31因子","第32因子"],
#                                      index=["第1因子", "第2因子", "第3因子", "第4因子", "第5因子","第6因子", "第7因子", "第8因子", "第9因子", "第10因子","第11因子", "第12因子",
#                                                         "第13因子", "第14因子", "第15因子", "第16因子", "第17因子","第18因子", "第19因子", "第20因子", "第21因子","第22因子", "第23因子","第24因子", "第25因子","第26因子"
#                                                         ,"第27因子", "第28因子", "第29因子", "第30因子", "第31因子","第32因子"])
# # 結果をExcelファイルに保存
# excel_file_path_correlation = "サイズ因子間相関.xlsx"
...
df_factor_only.to_excel("サイズ因子得点.xlsx", index=False)
...
# ,"第6因子", "第7因子", "第8因子", "第9因子", "第10因子","第11因子", "第12因子",
#                                                         "第13因子", "第14因子", "第15因子", "第16因子", "第17因子","第18因子", "第19因子", "第20因子", "第21因子","第22因子", "第23因子","第24因子", "第25因子","第26因子"
#                                                         ,"第27因子", "第28因子", "第29因子", "第30因子", "第31因子","第32因子", "第33因子","第34因子"