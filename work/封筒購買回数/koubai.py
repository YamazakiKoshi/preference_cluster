...
# 大分類
result_df['封筒_オーダーメイド'] = (df1['サイズ・規格'].str.contains('封筒') & df1['製品区分'].str.contains('オーダーメイド')).astype(int)
result_df['封筒_既製品'] = (df1['サイズ・規格'].str.contains('封筒') & df1['製品区分'].str.contains('既製品')).astype(int)
...
# 顧客ごとに統合
result_df.to_csv('./work/data/feature/koubai.csv', index=False, encoding='utf-8')
print(result_df)
